...
//         <div className="rounded-2xl border border-slate-200/80 bg-white px-4 py-6 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_24px_-12px_rgba(15,23,42,0.10)] sm:px-6 sm:py-7 md:px-10">
//           <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:items-center sm:gap-4">
//             <img
//               src="/logo-deiyai.png"
//               alt="Logo Kabupaten Deiyai"
//               className="h-16 w-16 shrink-0 object-contain sm:h-20 sm:w-20 md:h-24 md:w-24"
//             />
//             <div className="w-full pb-3 sm:flex-1 sm:pb-0">
...
//               </p>
//             </div>
//             {/* Spacer agar teks tetap center relatif terhadap card, menyeimbangkan lebar logo di kiri (hanya desktop) */}
//             <div className="hidden h-16 w-16 shrink-0 sm:block sm:h-20 sm:w-20 md:h-24 md:w-24" />
//           </div>

//           <div className="mx-auto mt-2 md:mt-5 h-[3px] w-full bg-slate-800" />

//           <div className="mt-5 flex flex-col items-center gap-3 text-center sm:flex-row sm:items-center sm:text-left">
...
//                             </span>
//                           </td>
//                           <td className="max-w-[440px] border border-slate-200 px-4 py-2.5 align-top text-md text-black">
...
//           <div className="mt-5 flex flex-col items-center gap-3 text-center sm:flex-row sm:items-center">
//             <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-purple-600 text-white shadow-sm shadow-purple-600/30">
//               <GraduationCap className="h-5 w-5" />
//             </div>
//             <div>
...
export default function RekapanMahasiswaPage() {
  ...
  // Filter & Search states
  const [searchTerm, setSearchTerm] = useState<string>("");
  const [verifikasiFilter, setVerifikasiFilter] = useState<"ALL" | "LOLOS">("ALL");
  ...
  const filteredData = isSearchActive
    ? (data || []).filter((item) => {
        ...
        const isLolosVerifikasi = (item?.verifikasi || "")
          .toLowerCase()
          .includes("lolos verifikasi");
        const matchesVerifikasi =
          verifikasiFilter === "ALL" ? true : isLolosVerifikasi;
        ...
        <div className="space-y-4 rounded-2xl border border-slate-200/80 bg-white p-5 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_8px_24px_-12px_rgba(15,23,42,0.10)]">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 pt-3.5">
            <div className="flex gap-2">
              ...
              <StatusButton
                active={verifikasiFilter === "LOLOS"}
                onClick={() => setVerifikasiFilter("LOLOS")}
